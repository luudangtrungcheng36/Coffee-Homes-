            ...
            <div class="about-user row">
                <div class="infor-user">
                    ...
                    <div class="row a">
                        ...
                        <p class="des">{{$auth->name}}</p>
                    </div>
                    <div class="row a">
                        <p class="title">Phone</p>
                        <p class="des">
                            @if($auth->phonenumber) {{$auth->phonenumber}} @else <span>Chưa có thông tin</span> @endif
                        </p>
                    </div>
                    <div class="row a">
                        <p class="title">Địa chỉ</p>
                        <p class="des">@if($auth->address) {{$auth->address}} @else <span>Chưa có thông tin</span> @endif</p>
                    </div>
                </div>
                ...
                <div class="infor-shipping">
                    ...
                    <div class="row a">
                        <p class="title">Phone</p>
                        <p class="des">0330203023</p>
                    </div>
                    <div class="row a">
                        <p class="title">Địa chỉ</p>
                        <p class="des">Hà nội</p>
                    </div>
                </div>
            </div>
